// Print the names of top 5 movies from the list given below. Ranking of movies is decided by their rating (`vote_average`)
let movies = [
    {
        adult: false,
...
let newArr = movies.sort(compare).slice(0, 5)
    .map(v => {
        return v.title
    })
